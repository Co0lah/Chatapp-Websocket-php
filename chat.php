    ...
    <div class="wrapper">
        <section class="chat-area">
            <header>
                ...
                <img src="php/uploads/<?php echo $row['img']; ?>"
                    alt="">
                <div class="details">
            ...
            <form action="#" class="typing-area">
                <!-- autocompletion = off ?? -->
                <input type="text" name="outgoing_id"
                    value="<?php echo $_SESSION['unique_id']; ?>"
                    hidden>
                <input type="text" name="incoming_id"
                    value="<?php echo $user_id; ?>" hidden>
                <input type="text" name="message" class="input-field" placeholder="Type a message here..">
                <button><i class="fab fa-telegram fa-spin fa-2x"></i></button>
            </form>
        </section>
    </div>
